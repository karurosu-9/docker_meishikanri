...
try {
    ...
    $sql = "UPDATE mitumori_list SET " . $column . " WHERE id= " . $mitumori_id;
...
<body>
    ...
    <form action="mitumori_edit_print_branch_master.php" method="post">
        <div class="print-button">
            <input type="hidden" name="id" value="<?php echo $rec['id']; ?>">
            <input type="submit" value="編集した日付で印刷する">
        </div>
    </form>
    <br>
    <br>
